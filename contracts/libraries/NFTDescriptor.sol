...
library NFTDescriptor {
    ...
    function generateSVG(string memory bgPalette, string memory imagePalette)
        internal
        pure
        returns (string memory)
    {
        string memory svg = string(
            abi.encodePacked(
                "<svg width='336' height='336'><g clip-path='url(#clip0_301_2)'><g style='mix-blend-mode:screen'>",
                string(
                    abi.encodePacked(
